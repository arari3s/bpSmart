...
class StudentPayment extends Model
{
    ...
    protected $fillable = [
        'student_classrooms_id', 'spp_id', 'sarana_id', 'pts1_id', 'pts2_id', 'pas_id', 'pat_id', 'infaq_id', 'pkl_id', 'ki_id', 'perpisahan_id', 'du_id', 'tabungan_id'
    ];
    ...
    // relationships one to many tabungan to student_payment
    public function tabungan()
    {
        return $this->belongsTo(Payment::class, 'tabungan_id', 'id');
    }
}

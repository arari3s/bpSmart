<div class="p-6 sm:px-20 bg-white border-b border-gray-200">
    ...
    <div class="mt-8 text-2xl">
        Welcome to SMK Bhakti Praja Margasari!
    </div>

    <div class="mt-6 text-gray-500 text-4xl">
        Mulai kebiasaan baru, tanpa banyak alasan
    </div>
</div>
    ...
    <div class="p-6">
        <div class="flex items-center">
            <div class="ml-4 text-lg text-gray-600 leading-7 font-semibold"><a
                    href="https://laravel.com/docs">Multimedia</a></div>
        </div>

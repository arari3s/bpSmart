<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            Pengeluaran Sarana &raquo; Tambah Pengeluaran
        </h2>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div>
                ...
                <form action="{{ route('dashboard.saranaexpenditure.store') }}" class="w-full" method="POST"
                    ...
                    <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full px-3">
                            ...
                            <a href="{{ route('dashboard.saranaexpenditure.index') }}"

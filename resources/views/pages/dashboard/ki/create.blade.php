<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            Pemasukan Kunjungan Industri &raquo; Tambah Pembayaran
        </h2>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div>
                ...
                <form action="{{ route('dashboard.kiincome.store') }}" class="w-full" method="POST"

        ...
        <div class="header-4-3" style="font-family: 'Poppins', sans-serif">
            <header x-data="{ open: false }">
                <div
                    ...
                    <a href="#">
                        <img src="{{ asset('assets/logo.png') }}" alt="logo-smk" class="w-20" />
                    </a>
                    <p class="text-2xl font-semibold leading-6 mx-0 lg:mx-5 my-4 lg:my-0 relative active">SMK BHAKTI
                        PRAJA <br> MARGASARI</p>
                </div>
            </header>
            ...
            <div>
                <div class="mx-auto flex pt-12 pb-16 lg:pb-20 lg:px-24 md:px-16 sm:px-8 px-8 lg:flex-row flex-col">
                    ...
                    <div
                        ...
                        <h1
                            class="title-font sm:text-5xl lg:text-6xl text-4xl mt-12 mb-8 font-semibold sm:leading-tight">
                            Mulai kebiasaan baru tanpa bayak alasan
                        </h1>
                        <div

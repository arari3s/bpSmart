        ...
        <div class=" mx-auto flex flex-wrap flex-row items-center justify-between">
            ...
            <div class="hidden lg:flex lg:items-center lg:w-auto w-full lg:ml-auto lg:mr-auto flex-wrap items-center text-base justify-center"
                ...
                <nav
                    ...
                    <a href="{{ route('profile.landing') }}"
                        class="block {{ request()->is('profile') ? 'nav-link active font-medium' : 'nav-link text-serv-text' }}">Profile</a>
                    <a href="{{ route('blog.landing') }}"
                        class="block {{ request()->is('blog') ? 'nav-link active font-medium' : 'nav-link text-serv-text' }}">Blog</a>
                    <a href="{{ route('contact.landing') }}"
                        class="block {{ request()->is('contact') ? 'nav-link active font-medium' : 'nav-link text-serv-text' }}">Contact</a>
                    <a href="{{ route('ppdb.landing') }}"
                        class="block {{ request()->is('ppdb') ? 'nav-link active font-medium' : 'nav-link text-serv-text' }}">PPDB
                        Online</a>
            ...
            @auth
                <div @click.away="open = false" class="hidden lg:block relative" x-data="{ open: false }">
                    <button @click="open = !open"
                        ...
                        <img class="inline ml-3 h-12 w-12 rounded-full" src="{{ asset('/assets/images/profile.png') }}"
                            alt="">
